...
qplot(total_accel_arm, colour=classe, data=train, xlab = expression(bold("Figure 2 - Total Acceleration on Arm - Potential Predictor for classe")))
...
qplot(gyros_arm_y, colour=classe, data=trainData, xlab = expression(bold("Figure 3 - Gyroscopic Measure Y on Arm - Potential Predictor for classe")))
